...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="montir.php">Montir</a>
            </li>
            <li class="nav-item ">
...
<nav class="navbar navbar-light" style="background-color: transparent;">
    <a class="btn btn-primary mt-2 mb-2" href="tambah-montir.php" role="button">+ Tambah Montir</a>
    ...
    <center>
        <table class="table" style="margin: 50px">
            <thead>
                <tr>
                    <th scope="col">Id Montir</th>
                    <th scope="col">Nama Montir</th>
                </tr>
            </thead>
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($montir as $row) : ?>
                    <tr>
                        <td><?= $row["id_montir"]; ?></td>
